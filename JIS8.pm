...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Ejis8::function_ord     = 'JIS8::ord'     if /\A ord \z/oxms;
                    $Ejis8::function_ord_    = 'JIS8::ord_'    if /\A ord \z/oxms;
                    $Ejis8::function_reverse = 'JIS8::reverse' if /\A reverse \z/oxms;
                    $Ejis8::function_getc    = 'JIS8::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= JIS8::escape();
...
=head1 Calling 'Ejis8::ignorecase()' (JIS8 software provides)

JIS8 software applies calling 'Ejis8::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (JIS8 software provides)

JIS8 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (JIS8 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (JIS8 software provides)

JIS8 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in JIS8 software and
