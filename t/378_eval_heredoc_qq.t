...
# eval <<"END" has eval "..."
if (eval Char::JIS8::escape <<"END") {
eval Char::JIS8::escape " if (Char::JIS8::length(q{²ÛÊÆÎÍÄÁØÇÙ¦Ü¶ÖÀÚ¿ÂÈÅ×Ñ³²Éµ¸ÔÏ¹Ìº´Ã±»·ÕÒÐ¼´ËÓ¾½}) == 47) { return 1 } else { return 0 } "
END
...
if (eval Char::JIS8::escape <<"END") {
eval Char::JIS8::escape qq{ if (Char::JIS8::length(q{²ÛÊÆÎÍÄÁØÇÙ¦Ü¶ÖÀÚ¿ÂÈÅ×Ñ³²Éµ¸ÔÏ¹Ìº´Ã±»·ÕÒÐ¼´ËÓ¾½}) == 47) { return 1 } else { return 0 } }
END
...
# eval <<"END" has eval q{...}
if (eval Char::JIS8::escape <<"END") {
eval Char::JIS8::escape q{ if (Char::JIS8::length(q{²ÛÊÆÎÍÄÁØÇÙ¦Ü¶ÖÀÚ¿ÂÈÅ×Ñ³²Éµ¸ÔÏ¹Ìº´Ã±»·ÕÒÐ¼´ËÓ¾½}) == 47) { return 1 } else { return 0 } }
END
...
my $var = q{q{ if (Char::JIS8::length(q{²ÛÊÆÎÍÄÁØÇÙ¦Ü¶ÖÀÚ¿ÂÈÅ×Ñ³²Éµ¸ÔÏ¹Ìº´Ã±»·ÕÒÐ¼´ËÓ¾½}) == 47) { return 1 } else { return 0 } }};
if (eval Char::JIS8::escape <<"END") {
eval Char::JIS8::escape $var
END
...
# eval <<"END" has eval {...}
if (eval Char::JIS8::escape <<"END") {
eval { if (Char::JIS8::length(q{²ÛÊÆÎÍÄÁØÇÙ¦Ü¶ÖÀÚ¿ÂÈÅ×Ñ³²Éµ¸ÔÏ¹Ìº´Ã±»·ÕÒÐ¼´ËÓ¾½}) == 47) { return 1 } else { return 0 } }
END
