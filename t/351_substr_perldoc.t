...
my $color  = Char::JIS8::substr $s, 4, 5;   # black
my $middle = Char::JIS8::substr $s, 4, -11; # black cat climbed the
my $end    = Char::JIS8::substr $s, 14;     # climebed the green tree
my $tail   = Char::JIS8::substr $s, -4;     # tree
my $z      = Char::JIS8::substr $s, -4, 2;  # tr
