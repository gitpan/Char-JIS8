...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ejis8::function_ord     = 'Char::JIS8::ord'     if /\A ord \z/oxms;
                    $Char::Ejis8::function_ord_    = 'Char::JIS8::ord_'    if /\A ord \z/oxms;
                    $Char::Ejis8::function_reverse = 'Char::JIS8::reverse' if /\A reverse \z/oxms;
                    $Char::Ejis8::function_getc    = 'Char::JIS8::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::JIS8::escape();
...
=head1 Calling 'Char::Ejis8::ignorecase()' (Char::JIS8 software provides)

Char::JIS8 software applies calling 'Char::Ejis8::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::JIS8 software provides)

Char::JIS8 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::JIS8 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::JIS8 software provides)

Char::JIS8 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::JIS8 software and
